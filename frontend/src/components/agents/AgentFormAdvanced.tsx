/**
 * Agent Form - Advanced Settings Section
 */

import { AgentCreateInput, AmbientSound } from '../../types';
...
export default function AgentFormAdvanced({ formData, onChange }: AgentFormAdvancedProps) {
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            <input
              ...
              onChange={(e) => onChange({ enable_backchannel: e.target.checked })}
              className="w-4 h-4"
            />
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              onChange={(e) => onChange({ enable_filler_words: e.target.checked })}
              className="w-4 h-4"
            />
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => onChange({ interruption_sensitivity: parseFloat(e.target.value) })}
              className="w-full"
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => onChange({ response_delay_ms: parseInt(e.target.value) })}
              className="w-full"
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => onChange({ responsiveness: parseFloat(e.target.value) })}
              className="w-full"
            />
      ...
      <div className="border-b pb-4 bg-gray-50 p-4 rounded-lg">
        ...
        <div className="space-y-4">
          <Select
            ...
            onChange={(e) => onChange({ ambient_sound: e.target.value as AmbientSound })}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => onChange({ ambient_sound_volume: parseFloat(e.target.value) })}
              className="w-full"
            />
      ...
      <div className="bg-gray-50 p-4 rounded-lg">
        ...
        <div className="space-y-4">
          <Input
            ...
            onChange={(e) => onChange({ max_call_duration_seconds: parseInt(e.target.value) })}
          />
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              onChange={(e) => onChange({ enable_auto_end_call: e.target.checked })}
              className="w-4 h-4"
            />
          ...
          {formData.enable_auto_end_call && (
            <Input
              ...
              onChange={(e) => onChange({ end_call_after_silence_ms: parseInt(e.target.value) })}
            />
          )}
        </div>
      </div>
